...
String get kApiBase => dotenv.get('BASE_URL');
String get kApiKey => dotenv.get('DEMO_ACCESS_TOKEN');
String get kTenantId => dotenv.get('DEMO_TENANT_ID');
...
class _SmsConsolePageState extends State<SmsConsolePage> {
  ...
  Future<void> loadCosts() async {
    ...
    final res = await http.get(
      ...
      headers: {'Authorization': 'Bearer $kApiKey', 'X-Tenant-Id': kTenantId},
    );
